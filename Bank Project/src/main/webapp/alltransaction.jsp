...
<body>
    ...
    <div class="container">
        <div class="passbook-card p-4">
            <h4 class="text-center mb-4">All Transaction</h4>
            <table class="table table-bordered text-center">
                ...
                <%for(Transaction list: al){ %>
                    ...
                    <tr>
                        ...
                        <td>₹<%=list.getAmount() %></td>   <!-- this line displaying total ammount transfered + account balance -->
						<%-- <td>₹<%=session.getAttribute("transferedamount") %></td>  <!-- it displaying transfered ammount  --> --%>
